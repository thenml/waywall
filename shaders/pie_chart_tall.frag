...
// 10,15968 at 340x16384
const vec2 pos_uv = vec2(0.03, 0.97464);
...
// background
const vec2 screen_size = vec2(340.0, 16384.0);
const vec2 center = vec2(170.0, 16064.0); // vec2(0.0, 15980.0) + vec2(170.0, 84.0)
